        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysTillNextPayment = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Incomes",
                columns: new[] { "IncomeID", "DaysTillNextPayment", "IncomeAmmount", "PayPeriodDays", "userId" },
                values: new object[,]
                {
                    { 1, 5, 100.0, 14, "1" },
                    { 2, 5, 200.0, 7, "2" }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, -50.0, new DateTime(2020, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "1" },
                    { 3, 200.0, new DateTime(2020, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "2" }
                });

            migrationBuilder.InsertData(
                table: "recurringPayments",
                columns: new[] { "RecurringPaymentId", "DaysTillNextPayment", "PaymenFrequencyDays", "PaymentAmount", "userId" },
                values: new object[,]
                {
                    { 1, 5, 14, 100.0, "1" },
                    { 2, 5, 7, 200.0, "2" }
